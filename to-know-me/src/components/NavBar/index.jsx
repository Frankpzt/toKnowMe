...
function NavBar(props) {
  return (
    <div className={style.home_nav}>
      ...
      <Link
        to="/MyCVPage"
        className={props.myCvActive ? style.myCvActive : style.home_nav_btn}
      >
        {props.lan ? "我的简历" : <div className={style.title_en}>MY CV</div>}
      </Link>
      <Link
        to="/AsWebDevPage"
        className={props.asWebActive ? style.myCvActive : style.home_nav_btn}
      >
        {props.lan ? (
          "我是WEB工程师"
        ) : (
          <div className={style.title_en}>AS WEB DEVELOPER</div>
        )}
      </Link>
      <Link to="/MyCVPage" className={style.home_nav_btn}>
        {props.lan ? (
          "我是产品经理"
        ) : (
          <div className={style.title_en}>AS PRODUCT MANAGER</div>
        )}
      </Link>
      <Link to="/MyCVPage" className={style.home_nav_btn}>
        {props.lan ? (
          ...
          <div className={style.title_en}>EDUCATION</div>
        )}
      </Link>
      <Link to="/MyCVPage" className={style.home_nav_btn}>
        {props.lan ? "博客" : <div className={style.title_en}>BLOG</div>}
      </Link>
