...
<div className={style.container}>
    <ul>
        <div className={style.contact_detail}>
            <li>
                <h2><a href="mailto: lihanyang19940724@126.com">Email: lihanyang19940724@126.com</a> </h2>
            </li>
        </div>
        <div className={style.social_media_list}>
            <li id={style.facebook}>
                <a href="https://www.facebook.com/profile.php?id=100009160932655">
                    <svg t="1609681596584" className="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="2501" width="30" height="30">
                        <path
                            ...
                            p-id="2502" fill="#ffffff"> </path>
                    </svg>
                </a>
            </li>
            <li >
                <a href="https://www.linkedin.com/in/hanyang-%EF%BC%88frank%EF%BC%89-li-337400185/">
                    <svg t="1609683776123" className="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="2505" width="30" height="30">
                        <path
            ...
            <li >
                <a href="https://github.com/Frankpzt">
                    <svg t="1610448772843" className="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="3828" width="30" height="30">
                        <path
