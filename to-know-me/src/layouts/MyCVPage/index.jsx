  ...
  const cnContent = (
    <div>
      ...
      <div className={style.education}>
        <h2>教育经历</h2>
        <p>
          <span>The University of Queensland - 信息技术 (硕士)</span>{" "}
          2019.07~2021.07
        </p>
        <p>
          <span>The Queensland University of Technology - 市场营销 (本科)</span>{" "}
          2015.02~2017.11{" "}
        </p>
      </div>
      <div className={style.in_uni_experience}>
        ...
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2021.04~2021.06</span>
          </h3>
          <h4>UI设计师</h4>
          <p>
            以TED
            talk为主题，归纳近10年的演讲主题，设计并绘制了数据可视化作品，成果在校内展示。作品基于
            Adobe Illustrator 和 Adobe InDesign。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2021.03~2021.05</span>
          </h3>
          <h4>软件工程师，硬件工程师</h4>
          <p>使用C语言独立开发基于ATmega324A的“Reversi”翻转棋游戏。</p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2021.03~2021.05</span>
          ...
          <h4>网络工程师</h4>
          <p>
            使用python编写类似TCP/IP和UDP的基于OSI
            模型的网络协议。该项目涉及socket programming， shortest-path
            algorithm的应用及对使用Wireshark抓取的数据包进行分析和故障排查。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学创新中心</span> <span>2021.01~2021.03</span>
          </h3>
          <h4>前端工程师</h4>
          <p>
            担任昆士兰大学旗下的start-up公司
            ”SPACE“的实习前端工程师。主要负责为已进入开发尾声的产品的
            React模块编写SCSS文件，优化页面布局，debugging等。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2020.07~2020.11</span>
          </h3>
          <h4>组长，前端工程师</h4>
          <p>
            带领团队提出，设计，开发并部署了全栈项目：电影拍摄地搜索引擎
            “InScene”。 从使用Adobe XD及Adobe
            Illustrator设计UI/UX模型到使用HTML，CSS，Jquery，AJAX, Leaflet,
            TheMovieDB,
            RapidAPI进行项目开发。该项目最终通过nginx部署在昆士兰大学自建的云端服务器
            UQzone上。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          ...
          <p>
            ...
            毕业设计作品。使用Android
            Studio开发基于安卓平台的中文学习软件。在接到项目提案后，根据目标用
            户选取合适的开发技术及API，包括使用Google
            Firebase快速建立后端数据库， 使用Android Studio适应
            组内多数工程师偏好Java的需求，加快开发时间，使用成熟的Google
            Translation API开发核心功能等。成
            功的在四个月的时间内开发出了Minimal Viable Product (MVP)
            为该项目的后续迭代提供了基础。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2020.05~2020.07</span>
          </h3>
          <h4>组长，项目经理</h4>
          <p>
            带领团队提出并设计“外侵物种检测软件”
            *该开发企划已被其他昆士兰大学EAIT开发团队作为该组的毕业
            设计作品开发。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2020.04~2020.06</span>
          </h3>
          <h4>软件开发工程师</h4>
          <p>
        ...
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2020.04~2020.07</span>
          </h3>
          <h4>UI/UX设计师</h4>
          <p>
            独立设计手机应用"Physical Media Anywhere"
            (PAW)的高保真交互模型。应用user-centered设计理念，
            模型经历三次迭代，实现了从低到中到高保真度的过渡。模型基于AdobeXD。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2020.03~2021.05</span>
          </h3>
          <h4>全栈工程师</h4>
          <p>
        ...
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2019.10~2019.11</span>
          </h3>
          <h4>WEB前端工程师</h4>
          <p>
            独立设计并开发了以“度假村”为主题的网站前端页面。全程贯彻基于用户视角的网站开发，懂得如何设计
            具有自适应功能并对用户友好的网站。了解如何设计可通过WCAG
            2.0标准的网页，并基于故障弱化和逐步
        ...
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2019.09~2019.10</span>
          </h3>
          <h4>软件开发工程师</h4>
          <p>
            独立开发基于python 的 “马里奥
            “游戏。期间使用面向对象编程的框架，并使用Tkinter模块搭建GUI组
            件，以及pillow模块对游戏开发所需图片文件进行处理。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰大学</span> <span>2019.07~2020.09</span>
          </h3>
          <h4>数据工程师</h4>
          <p>
            ...
            integrity constraints, 创建materialized/virtual views, triggers,
            运用query optimization and indexing的方法提高数据查询效率。
          </p>
        </div>
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰科技大学</span> <span>2017.07~2017.11</span>
          </h3>
          <h4>市场分析师</h4>
          <p>
        ...
        <div className={style.in_uni_expItem}>
          <h3>
            <span>昆士兰科技大学</span> <span>2017.02~2017.06</span>
          </h3>
          <h4>市场分析师</h4>
          <p>
            为 澳大利亚“Escape Travel”
            旅游公司进行了数字营销市场分析并撰写市场分析报告。通过对该公司的CPC定价模型分析，优化该公司现有的Search
            Engine Marketing (SEM)策略，并给出分析报告。
          </p>
        </div>
      </div>
      <div className={style.working_experience}>
        ...
        <div className={style.working_expItem}>
          <h3>
            <span>澳大利亚金色湖畔地产开发有限公司</span> 2017.12~2019.03
          </h3>
          <h4>企业服务部经理</h4>
          <p>
      ...
      <div className={style.project_experience}>
        ...
        <div className={style.project_expItem}>
          <h3>
            <span>全栈项目：租车管理平台SPA</span> 2021.08~2021.11
          </h3>
          <h4>全栈工程师</h4>
          <p>
            使用react+nodejs开发vehicle renting management system (VRMS).
            开发模式采取agile模式，参与后
            端server，数据库搭建以及前端页面布局与组件编写的工作。项目运用了material
            ui， express.js， axios 等npm
            package加速开发进度，保证代码可维护性。通过redux管理react state。
          </p>
        </div>
        <div className={style.project_expItem}>
          <h3>
            <span>澳大利亚租车公司 “Qubit Rental” 主页及后台系统开发</span>{" "}
            2020.12~2021.01
          </h3>
          <h4>前端工程师，项目经理</h4>
          <p>
      ...
      <div className={style.comment}>
        <div className={style.language}>
          <h3>语言：</h3>
          <p>
            英语流利，雅思均分7其中听力7.5。PTE均分76/90其中听力81/90,
            口语87/90。持有澳大利亚翻译 协会NATTI认证的社区语言翻译资格（CCL
            certificate), 可胜任交替传译工作。
          </p>
        </div>
        <h2>自我评价：</h2>
        <p>
